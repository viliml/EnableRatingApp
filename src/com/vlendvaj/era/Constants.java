...
public class Constants {
	...
	public static final YailList requestHeaders = YailList.makeList(new YailList[] { YailList
			.makeList(new String[] { "Content-Type", "application/x-www-form-urlencoded" }) });

	public static void runQuery(Web web, String query) {

		web.Url(Constants.URL);
		web.RequestHeaders(Constants.requestHeaders);
		web.PostText(web.BuildRequestData(YailList.makeList(new YailList[] {
				YailList.makeList(new String[] { "key", web.UriEncode(Constants.SQLKEY) }),
